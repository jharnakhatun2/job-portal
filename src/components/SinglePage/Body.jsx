...
const Body = () => {
  return (
    <div className="text-gray-600 text-sm font-inter font-light">
      ...
      {/* Related Jobs */}
      <div className="space-y-3 sm:space-y-2 mt-5 sm:mt-10">
        <h2 className="text-lg sm:text-xl font-bold">Related Jobs (2)</h2>

        <div className="sm:flex items-center gap-3 border-t border-gray-300 pt-3 pb-1">
          <p className="text-[15px] text-gray-800 hover:text-primary cursor-pointer">Java Developer Linux Java Dev <span className="text-gray-400 text-sm"> on</span></p>
        ...
        <div className="sm:flex gap-3 border-t border-gray-300 pt-3 pb-1">
          <p className="text-[15px] text-gray-800 hover:text-primary cursor-pointer">Senior Stock Technician Required <span className="text-gray-400 text-sm"> on</span></p>
          <div className="flex justify-between sm:w-3/5 text-sm">
            <p className="text-gray-500">July 10, 2023</p>
