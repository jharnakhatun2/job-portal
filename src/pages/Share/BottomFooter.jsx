    ...
    return (
        <footer className="bg-neutral text-neutral-content items-center">
            <div className="footer sm:footer-horizontal max-w-7xl mx-auto justify-items-center justify-between">
                ...
                <div>
                    <p className="flex items-center cursor-pointer text-primary">Back to top <BiSolidArrowToTop className="border border-primary text-2xl rounded-full bg-primary text-white"/></p>
                </div>
            </div>
        </footer>
    )
