            ...
            <footer className="bg-zinc-800 text-gray-500">
                <div className="footer sm:footer-horizontal sm:max-w-7xl mx-auto w-full px-3 xl:px-0 py-8">
                    ...
                    <nav>
                        ...
                        <div>
                        <p>Mirpur 12 / 13 No Road, Dhaka</p>
                        <p>Bangladesh9001</p>
                        <p>info@jobportal.com</p>
                        </div>
                        <div className="grid grid-flow-col gap-4 transition-all ease-in-out duration-700">
                            <a>
                                <svg
                                    ...
                                    height="34"
                                    viewBox="0 0 24 24"
                                    className="fill-current border p-2 rounded-full text-primary hover:text-white border-gray-500 hover:bg-primary transition-all ease-in-out duration-300 cursor-pointer">
                                    <path
